...
public class Gescom {
    ...
    private static void listerClients(Representant unRepresentant) {
        ...
        for (Client client : lesClients) {
            System.out.println("ID Client: " + client.getIdClient() + ", Raison Sociale: " + client.getRaisonSociale());
            List<Commande> commandes = client.getLesCommandes();
            for (Commande commande : commandes) {
                System.out.println("  Commande ID: " + commande.getIdCommande() + ", Date: " + commande.getDate());
            }
        }
    }
